...
public class PDOClientHandler implements Runnable {
    private final server.pdo.PDOServer server;
    ...
    public PDOClientHandler(Socket socket, server.pdo.PDOServer server, Integer key, DBConnect dbConnect) throws IOException, SQLException {
        clients_count++;
        this.key = key;
        this.server = server;
