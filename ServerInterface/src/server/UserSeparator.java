        ...
        try {
            ...
            switch (userStatus(userInfo)) {
                case 1:
                    ...
                    Platform.runLater(() -> server.controller.numOfAdminLabel
                            .setText(String.valueOf(server.adminClients.size())));
                ...
                case 0:
                    ...
                    Platform.runLater(() -> server.controller.numOfClientsLabel
                            .setText(String.valueOf(server.userClients.size())));
