...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        controller.toggleSaveOn.setOnAction(ActionEvent -> controller.server.toggleSaveMode(controller.toggleSaveOn.isSelected()));
        controller.toggleSaveOff.setOnAction(ActionEvent -> controller.server.toggleSaveMode(controller.toggleSaveOn.isSelected()));
